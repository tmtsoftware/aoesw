...
loop For various pupil offsets
aosq -> vnwSsm ++: nudgePwfs
note left: Offset SSM and calibrate offset model
return Completed
end
...
aosq -> rtc ++: loopOpen
note left: Open loops when stopped
return Completed
alt If more pinhole locations
aosq -> vnwSsm ++: positionPwfs
